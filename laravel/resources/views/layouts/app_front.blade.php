    ...
    <header x-data="{ open: false, scrolled: false }" x-init="window.addEventListener('scroll', () => scrolled = window.scrollY > 20)"
        ...
        <nav class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16 md:h-20">
                {{-- Logo --}}
                <a href="{{ route('profiledesaindex') }}" class="flex items-center gap-3 group">
                    <img src="{{ asset('assets/logo-desadigital.svg') }}" alt="logo" class="w-9 h-9 md:w-10 md:h-10 transition-transform group-hover:scale-105">
                        ...
                        @if(isset($item['dropdown']))
                            <div x-data="{ sub: false }">
                                ...
                                <div x-show="sub" x-cloak class="bg-gray-50">
                                    @foreach($item['dropdown'] as $sub)
                                        <a href="{{ route($sub['route']) }}" @click="open = false"
            ...
            <div class="grid md:grid-cols-3 gap-8 md:gap-12">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        <img src="{{ asset('assets/logo-desadigital.svg') }}" alt="logo" class="w-10 h-10">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        <li><a href="{{ route('profiledesaindex') }}" class="text-slate-300 hover:text-white text-sm transition flex items-center gap-2"><span class="w-1 h-1 bg-blue-400 rounded-full"></span>Beranda</a></li>
                        <li><a href="{{ route('demografi') }}" class="text-slate-300 hover:text-white text-sm transition flex items-center gap-2"><span class="w-1 h-1 bg-blue-400 rounded-full"></span>Demografi</a></li>
                        <li><a href="{{ route('berita') }}" class="text-slate-300 hover:text-white text-sm transition flex items-center gap-2"><span class="w-1 h-1 bg-blue-400 rounded-full"></span>Berita</a></li>
                        <li><a href="{{ route('pelayanan') }}" class="text-slate-300 hover:text-white text-sm transition flex items-center gap-2"><span class="w-1 h-1 bg-blue-400 rounded-full"></span>Pelayanan</a></li>
                        <li><a href="{{ route('map') }}" class="text-slate-300 hover:text-white text-sm transition flex items-center gap-2"><span class="w-1 h-1 bg-blue-400 rounded-full"></span>Peta Desa</a></li>
                        <li><a href="{{ route('pasardesa') }}" class="text-slate-300 hover:text-white text-sm transition flex items-center gap-2"><span class="w-1 h-1 bg-blue-400 rounded-full"></span>Pasar Desa</a></li>
                        <li><a href="{{ route('contact') }}" class="text-slate-300 hover:text-white text-sm transition flex items-center gap-2"><span class="w-1 h-1 bg-blue-400 rounded-full"></span>Kontak</a></li>
                    </ul>
                </div>
