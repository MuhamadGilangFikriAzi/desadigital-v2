...
@section('title', 'Pelayanan - Desa Digital')
...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gray-100 rounded-lg shadow-sm p-6 mb-8">
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="w-full md:w-1/2 text-center md:text-left">
                    ...
                    <a href="{{ route('login') }}" class="inline-block bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-lg transition mt-4">
        ...
        <div class="flex flex-wrap -mx-3">
            @foreach ($templateSurat as $item)
                <div class="w-full md:w-1/2 lg:w-1/3 px-3 mb-4">
                    <a href="{{ route('login') }}" class="block no-underline h-full">
                        <div class="bg-white rounded-lg shadow-sm text-center p-6 h-full hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                            ...
                            <h5 class="font-semibold text-gray-800">{{ $item->type_surat }}</h5>
                        </div>
                    </a>
                </div>
            @endforeach
