                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    @if ($villageVision)
                        <div class="mb-6">
                            ...
                            <div class="text-gray-700 leading-relaxed">{!! $villageVision->content !!}</div>
                        </div>
                    @endif
                    @if ($villageMission)
                        <div>
                    ...
                    <div class="text-center mt-6">
                        <img src="{{ asset('img/profilevillage/visimisi.png') }}" alt="Visi dan Misi Desa Digital" class="w-full h-auto rounded-lg shadow-sm">
                    </div>
                </div>
            </div>
        </div>
