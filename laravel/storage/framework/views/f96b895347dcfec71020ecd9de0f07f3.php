...
<body class="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative">
        ...
        <div class="text-center mb-8">
            <a href="<?php echo e(route('profiledesaindex')); ?>" class="inline-flex items-center gap-3">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex items-stretch border border-gray-300 rounded-xl focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-200 transition">
                            ...
                            <input id="nik" type="text"
                                ...
                                name="nik" placeholder="Masukkan NIK" value="<?php echo e(old('nik')); ?>" required maxlength="16">
                        </div>
                        <?php $__errorArgs = ['nik'];
                    ...
                    <div class="mb-2">
                        ...
                        <div class="flex items-stretch border border-gray-300 rounded-xl focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-200 transition">
                            ...
                            <input id="no_wa" type="text"
                                class="flex-1 px-4 py-3 outline-none onlynumber"
                                name="no_wa" placeholder="contoh: 6281234567890" value="<?php echo e(old('no_wa')); ?>" required maxlength="16">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center mt-6 pt-6 border-t border-gray-100">
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-1 text-gray-400 text-sm hover:text-gray-600 transition">
