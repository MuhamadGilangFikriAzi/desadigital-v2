...
<html>
    ...
    <head>
        ...
        <!-- Core JS files -->
        <script src="<?php echo e(url("limitless/global_assets/js/main/jquery.min.js")); ?>"></script>
        <script src="<?php echo e(url("limitless/global_assets/js/plugins/loaders/blockui.min.js")); ?>"></script>
        
        <!-- /core JS files -->

        <!-- Theme JS files -->
        <script src="<?php echo e(url("limitless/global_assets/js/plugins/forms/selects/select2.min.js")); ?>"></script>
        <?php echo $__env->yieldContent("script_before_app"); ?>

        
        <?php echo $__env->yieldContent("head_theme_script"); ?>
        <!-- /theme JS files -->

        
        

        <link rel="stylesheet" href="<?php echo e(url("trumbowyg/dist/ui/trumbowyg.min.css")); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(url("trumbowyg/dist/plugins/table/ui/sass/trumbowyg.table.scss")); ?>">
        <script src="<?php echo e(url("trumbowyg/dist/plugins/table/trumbowyg.table.js")); ?>"></script>

        
        <script src="<?php echo e("https://cdn.jsdelivr.net/npm/sweetalert2@11"); ?>"></script>
    ...
    <body class="hold-transition sidebar-mini layout-fixed" style="height: auto;">
            ...
            <div id="app">
                        ...
                        <?php else: ?>
                            ...
                            <div class="nav-item dropdown">
                                <a class="nav-link" data-toggle="dropdown" href="#">
                                    <?php echo e(Auth::user()->name); ?> <i class="fas fa-angle-down"></i>
                                </a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?php echo e(route("users.edit", Auth::user()->id)); ?>">Edit
                                        Profile</a>
                ...
                <aside class="main-sidebar sidebar-dark-primary elevation-4">
                    ...
                    <a href="#" class="brand-link text-center">
                        <img src="<?php echo e(asset("img/kab-logo.png")); ?>" alt="img"
                        ...
                        <nav class="mt-2">
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                                ...
                                <?php if (\Illuminate\Support\Facades\Blade::check('role', "Staff Desa")): ?>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route("templatesurat.index")); ?>"
                                            class="nav-link <?php if(Request::is("templatesurat/*") || Request::is("templatesurat")): ?> active <?php endif; ?>">
                                ...
                                <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', "User|Staff Desa")): ?>
                                    <li class="nav-item">
                                        <a href="<?php echo e(url("surat")); ?>"
                                            class="nav-link <?php if(Request::is("surat/*") || Request::is("surat")): ?> active <?php endif; ?>">
                                ...
                                <?php if (\Illuminate\Support\Facades\Blade::check('role', "Staff Desa")): ?>
                                    <li class="nav-item has-treeview <?php if(Request::is("news/*") ||
                                            Request::is("news") ||
                                            Request::is("aparatur/*") ||
                                            Request::is("aparatur") ||
                                            Request::is("villagedata/*") ||
                                            Request::is("villagedata") ||
                                            Request::is("stores")): ?> menu-open <?php endif; ?>">
                                        <a href="#" class="nav-link <?php if(Request::is("news/*") ||
                                                Request::is("news") ||
                                                Request::is("aparatur/*") ||
                                                Request::is("aparatur") ||
                                                Request::is("villagedata/*") ||
                                                Request::is("villagedata") ||
                                                Request::is("stores")): ?> active <?php endif; ?>">
                                        ...
                                        <ul class="nav-item nav-treeview">
                                            <li class="nav-item">
                                                <a href="<?php echo e(route("news.index")); ?>"
                                                    class="nav-link <?php if(Request::is("news/*") || Request::is("news")): ?> active <?php endif; ?>">
                                                    <i class="fas fa-newspaper nav-icon"></i>
                                                    <p>Berita</p>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo e(route("aparatur.index")); ?>"
                                                    class="nav-link <?php if(Request::is("aparatur/*") || Request::is("aparatur")): ?> active <?php endif; ?>">
                                                    <i class="fas fa-user-tie nav-icon"></i>
                                                    <p>Aparatur</p>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo e(route("villagedata.index")); ?>"
                                                    class="nav-link <?php if(Request::is("villagedata/*") || Request::is("villagedata")): ?> active <?php endif; ?>">
                                            ...
                                            <li class="nav-item">
                                                <a href="<?php echo e(route("stores.index")); ?>"
                                                    class="nav-link <?php if(Request::is("stores/*") || Request::is("stores")): ?> active <?php endif; ?>">
                                    ...
                                    <li class="nav-item has-treeview <?php if(Request::is("user/*") || Request::is("user")): ?> menu-open <?php endif; ?>">
                                        <a href="#"
                                            class="nav-link <?php if(Request::is("user/*") || Request::is("user")): ?> active <?php endif; ?>">
        ...
        <script src="<?php echo e(url("adminlte/plugins/jqvmap/maps/jquery.vmap.world.js")); ?>"></script>
        <!-- jQuery Knob Chart -->
        ...
        <script src="<?php echo e(url("adminlte/dist/js/demo.js")); ?>"></script><!-- ./wrapper -->
        <script src="//ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
        <script>
            window.jQuery || document.write('<script src="js/vendor/jquery-3.3.1.min.js"><\/script>')
        </script>
        <script src="<?php echo e(url("trumbowyg/dist/trumbowyg.min.js")); ?>"></script>

        <script src=" <?php echo e(url("trumbowyg/dist/plugins/fontsize/trumbowyg.fontsize.js")); ?>"></script>
        <script src=" <?php echo e(url("trumbowyg/dist/plugins/fontfamily/trumbowyg.fontfamily.js")); ?>"></script>
        <script src=" <?php echo e(url("trumbowyg/dist/plugins/colors/trumbowyg.colors.js")); ?>"></script>
        <script src=" <?php echo e(url("trumbowyg/dist/plugins/table/trumbowyg.table.js")); ?>"></script>
