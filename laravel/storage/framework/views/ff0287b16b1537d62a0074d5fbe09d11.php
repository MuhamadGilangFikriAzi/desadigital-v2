...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-right mb-2">
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-medium transition hover:underline">
                            Lupa Password?
                        </a>
                    </div>
                ...
                <div class="text-center mt-6 pt-6 border-t border-gray-100">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('profiledesaindex')); ?>" class="inline-flex items-center gap-1 text-gray-400 text-xs mt-3 hover:text-gray-600 transition">
