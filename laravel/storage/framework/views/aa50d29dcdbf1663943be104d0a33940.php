    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition border border-gray-100">
                ...
                <div class="text-3xl font-bold text-gray-800"><?php echo e(number_format($jumlahPenduduk, 0, ',', '.')); ?></div>
            ...
            <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition border border-gray-100">
                ...
                <div class="text-3xl font-bold text-gray-800"><?php echo e(number_format($jumlahKK, 0, ',', '.')); ?></div>
            ...
            <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition border border-gray-100">
                ...
                <div class="text-3xl font-bold text-gray-800"><?php echo e($jumlahSekolahNegri + $jumlahSekolahSwasta); ?></div>
            ...
            <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition border border-gray-100">
                ...
                <div class="text-3xl font-bold text-gray-800"><?php echo e($jumlahAparatur); ?></div>
...
<section id="layanan" class="py-16 md:py-20 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('pelayanan')); ?>" class="group bg-white rounded-2xl p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition text-center">
            ...
            <a href="<?php echo e(route('berita')); ?>" class="group bg-white rounded-2xl p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition text-center">
            ...
            <a href="<?php echo e(route('pasardesa')); ?>" class="group bg-white rounded-2xl p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition text-center">
...
<section id="berita" class="py-16 md:py-20 bg-gray-50">
    <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition mb-6 border border-gray-100">
                <div class="flex flex-col md:flex-row">
                    <div class="md:w-1/3 bg-gray-200 min-h-[200px] relative overflow-hidden">
                        <?php if($berita->image): ?>
                            <img src="<?php echo e(Storage::url('news/' . $berita->image)); ?>" class="w-full h-full absolute inset-0 object-cover" alt="<?php echo e($berita->title); ?>">
                        <?php else: ?>
                    ...
                    <div class="md:w-2/3 p-6 flex flex-col justify-center">
                        <div class="flex items-center gap-2 text-xs text-gray-400 mb-2">
                            <span class="bg-blue-100 text-blue-700 px-2 py-0.5 rounded font-medium"><?php echo e($berita->category ?? 'Berita'); ?></span>
                            <span><?php echo e($berita->created_at->format('d M Y')); ?></span>
                        </div>
                        <h3 class="text-xl font-bold text-gray-800 mb-2"><?php echo e($berita->title); ?></h3>
                        <p class="text-gray-500 text-sm mb-4"><?php echo e(Str::limit(strip_tags($berita->content), 150, '...')); ?></p>
                        <a href="<?php echo e(route('berita.show', $berita->id)); ?>" class="inline-flex items-center gap-1 text-blue-600 font-medium text-sm hover:text-blue-800 transition">
                            Baca Selengkapnya
        ...
        <div class="text-center mt-8">
            <a href="<?php echo e(route('berita')); ?>" class="inline-flex items-center gap-2 bg-blue-600 text-white font-semibold px-6 py-3 rounded-xl hover:bg-blue-700 transition shadow">
                Lihat Semua Berita
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
            </a>
        </div>
...
<section class="py-16 md:py-20 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="inline-block bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 shadow-sm border border-blue-100 text-center w-full max-w-md mx-auto">
            ...
            <div class="text-5xl font-bold text-blue-700 mt-2"><?php echo e($jumlahAparatur); ?></div>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <div class="flex flex-wrap justify-center gap-6">
                <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 bg-white text-blue-800 font-semibold px-6 py-3 rounded-xl hover:bg-blue-50 transition shadow-lg">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    Hubungi Kami
                </a>
                <a href="<?php echo e(route('map')); ?>" class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/30 text-white font-semibold px-6 py-3 rounded-xl hover:bg-white/20 transition">
...
<?php echo $__env->make('layouts.app_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/profilevillage/home.blade.php ENDPATH**/ ?>